...
def video_loop():
    ...
    while(cap.isOpened()):
        ...
        G = (b1 * int(up.get()) - min(mylist1)) / b1
        Y = (b1 * int(down.get()) - min(mylist1)) / b1
            # print( b1,round(G))
...
up = tk.StringVar()
strike_zone_up_entry = tk.Entry(strike_zone_up,textvariable = up)
...
down = tk.StringVar()
strike_zone_down_entry = tk.Entry(strike_zone_down,textvariable = down)
